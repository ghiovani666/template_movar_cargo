                    ...
                    <nav class="navbar navbar-expand-md">
                        ...
                        <div class="collapse navbar-collapse mean-menu">
                            <ul class="navbar-nav m-auto">
                                ...
                                <li class="nav-item">
                                    <a id="quienes_somos" href="index.php" class="nav-link">¿Quiénes Somos?</a>
                                </li>
                                <li class="nav-item">
                                    <a id="mision_vision" href="index.php" class="nav-link">
                                        Misión y visión

                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a id="servicios_menu" href="index.php" class="nav-link">
                                        Servicios
                                    </a>
                                </li>

                                <li class="nav-item">
                                    <a id="cotizar_menu" href="index.php" class="nav-link">
                                        Cotizar</a>
                                </li>
                                <li class="nav-item">
                                    <a id="contacto_menu" href="index.php" class="nav-link">Contacto</a>
                                </li>
                            </ul>
