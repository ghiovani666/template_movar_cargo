...
<body>
    ...
    <section class="our-services-area our-service-area-three" id="servicios_main">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-sm-6" style="background: #1569ae;height: 375px;">
                    <div class="services-content" style="text-align:center;margin-top: 70px;">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="single-services bg-1" style="text-align: center;height: 404px;">
    ...
    <script>
    $('#open_modal,#open_modal1,#open_modal2,#open_modal3,#open_modal4').click(function() {
