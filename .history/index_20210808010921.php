...
<body>
    ...
    <!-- carrucel -->
    <section class="hero-slider-area" id="index_mains">
    ...
    <!-- mision y vision -->
    <section class="about-area pt-100 pb-70" id="mision_vision_main">
        <div class="container">
            <div class="row ">
                <div class="col-lg-6">
                    <div class="about-content">
    ...
    <section class="our-services-area our-service-area-three" id="transporte_internacional" style="margin-top: 150px;">
        <div class="container">
            <div class="col-sm-12">
    ...
    <section class="our-services-area our-service-area-three" id="agenciamiento_aduana" style="margin-top: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-6">
    ...
    <section class="our-services-area our-service-area-three" id="trasporte_distribucion" style="margin-top: 50px;">
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-sm-6" style="background: #1569ae;height: 405px;">
                    <div class="services-content" style="text-align:center;margin-top: 70px;">
                ...
                <div class="container">
                    ...
                    <div class="partner-slider owl-theme owl-carousel">
                        <div class="partner-item">
                            <a href="#">
                                <img src="assets/img/aduanas/Amazing_gas_1.png" alt="Image">
                            </a>
                        </div>
                        <div class="partner-item">
                            <a href="#">
                                <img src="assets/img/aduanas/bodegas_don_luis_1.png" alt="Image">
                            </a>
                        </div>
                        <div class="partner-item">
                            <a href="#">
                                <img src="assets/img/aduanas/packplusperu.png" alt="Image">
                            </a>
                        </div>
                        <div class="partner-item">
                            <a href="#">
                                <img src="assets/img/aduanas/porfin_1.png" alt="Image">
                            </a>
                        </div>
                        <div class="partner-item">
                            <a href="#">
            ...
            <div class="row align-items-center">
                <div class="col-lg-4">
                    <div class="contact-info">
                        ...
                        <p>Si deseas comunicarte con nosotros, por favor rellenar el siguiente formulario y en breve nos
                            comunicaremos</p>
                        <ul class="address">
                            <li class="location">
                                <i class="bx bxs-location-plus"></i>
                                <span>Dirección</span>
                                Av. Camino Real N° 479, Ofic. 502 - San Isidro - Lima
                            </li>
                            <li>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single-contact-info">
                        ...
                        <h3>Ubicación</h3>
                        <span>Av. Camino Real N° 479, <br> Ofic. 502 - San Isidro - Lima</span>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single-contact-info">
    ...
    $('#index_principal').click(function() {
        ...
        $('#index_principal').addClass('active');
        $('#quienes_somos').removeClass('active');
        $('#mision_vision').removeClass('active');
    ...
    $('#quienes_somos').click(function() {
        ...
        $('#index_principal').removeClass('active');
