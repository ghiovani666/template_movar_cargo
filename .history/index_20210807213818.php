        ...
        <div class="container">
            <div class="row ">
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="about-img" style="display: flex;">
                            <img src="assets/img/cambios/aduna-mision.jpg" alt="Image" style="margin-right: 45px;width: 85px;">
                            <h2>Misión</h2>
                        </div>
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <div class="about-img" style="display: flex;">
                            <img src="assets/img/cambios/aduna-vision.jpg" alt="Image" style="margin-right: 45px;width: 85px;">
                            <h2>Visión</h2>
                        </div>
        ...
        <div class="container">
            ...
            <div class="partner-area bg-color">
                ...
                <div class="container">
                    ...
                    <div class="col-sm-12">
                        <div class="services-content">
                            <h3 style="text-align:center;font-size: 30px;margin-bottom: 60px;">Ellos ya confían en nosotros</h3>
                        </div>
                    </div>
