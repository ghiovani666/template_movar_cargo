...
<body>
    ...
    <section class="our-services-area our-service-area-three" id="servicios_main">
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="services-content" style="text-align:center;margin-top: 50px;">
                        <h2>Elige cómo transportar tu carga</h2>
                        <p>Transportamos tu carga por la vía más adecuada para tu negocio
                        </p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="services-content" style="text-align:center;margin-top: 50px;">
                        <h2>¿Necesitas representación y asesoría?</h2>
                        <p>Evita inconvenientes y sobrecostos en tus procedimientos aduaneros
                        </p>
                    </div>
                </div>
            </div>
