...
<body>
    ...
    <!-- carrucel -->
    <div class="hero-wrap">
        <div class="home-slider owl-carousel" style="margin-bottom: 105px;">


            <div class="slider-item" style="background-image:url(assets/img/slider/slider-2.jpg);margin-top: 105px;">
