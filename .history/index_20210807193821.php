            ...
            <div class="row ">
                <div class="col-lg-6">
                    ...
                    <div class="about-img" style="display: flex;">
                        <img src="assets/img/cambios/aduna-mision.jpg" alt="Image" style="margin-right: 45px;">
                        <h2>Misión</h2>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                    <div class="about-img" style="display: flex;">
                        <img src="assets/img/cambios/aduna-vision.jpg" alt="Image" style="margin-right: 45px;">
                        <h2>Visión</h2>
                    </div>
